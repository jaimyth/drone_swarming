...
ag1 = Agent(environment= env, x= 100, y = 200, color = [255,0,0])
random.seed(10)
env.add_agent(ag1)
for i in range(20):
    ag = Agent_Flock(environment=env, x = random.randint(150, 250), y = random.randint(195, 205))
    env.add_agent(ag)
...
while run:
    ...
    centroid = ag1.centroid_neighbors(ag1.sense_neighbors(5, 500))
